...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.RankRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ItiTradeMstRepo.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ChecklistRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.DistrictMasterRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.MeritListRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ItiRepository.fragments#0'.
     */
