...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.server.backend.entity.Checklist", "com.server.backend.entity.dist_master", "com.server.backend.entity.Iti", "com.server.backend.entity.ititrade", "com.server.backend.entity.Iti_trade_mst", "com.server.backend.entity.MeritList", "com.server.backend.entity.RankEntity");
