...
/**
 * Bean definitions for {@link RankRepository}.
 */
@Generated
public class RankRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'rankRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getRankRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'rankRepository'.
   */
  public static BeanDefinition getRankRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, RankRepository.class, RankEntity.class, RankId.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.server.backend.Repository.RankRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.RankRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.server.backend.Repository.RankRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getRankRepositoryInstanceSupplier();
